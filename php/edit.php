<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $price = $_POST['price'];
        $img = $_POST['img'];
        $query = "UPDATE `products` SET `name` = '$name', `category` = '$category', `descr` = '$descr', `price` = '$price', `img` = '../../img/$img', `brand` = '$brand' WHERE `id` = '$id'";
    ...
    <div class="grid sm:grid-cols-1 lg:grid-cols-2">
        ...
        <div class="grid row-span-2 mx-5 mt-5 rounded-md gap-5">
            <div class="flex items-center border bg-orange-500 border-solid border-orange-400 align-center justify-center rounded-md">
                <p class="font-bold text-white text-lg p-6 uppercase">Редактирование товара</p>
            </div>
            <div class="grid border-2 border-solid border-gray-200 rounded-md min-h-full">
                <?php $query = "SELECT * FROM `products` WHERE `id` = '$id'"; $result = mysqli_query($db, $query);
                ...
                <form action="" method="post">
                        ...
                        <input class="border rounded-md p-2" type="text" name="name" id="name" value = "<?php echo $name; ?>" placeholder="Введите название товара">
                        ...
                        <select name="brand">
                            <option name="brand"><?php echo $brand; ?></option>
                        ...
                        <input class="border rounded-md p-2" type="text" name="price" id="name" value = "<?php echo $price; ?>" placeholder="Введите цену">
